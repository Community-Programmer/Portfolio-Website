      ...
      <section className="py-20 px-4 bg-gradient-to-br from-slate-50 to-[var(--portfolio-primary-50)] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
              ...
              >
                <div className="tech-card relative w-full h-32 cursor-pointer perspective-1000">
                  ...
                  >
                    ...
                    <div
                      className="tech-card-face tech-card-back absolute inset-0 w-full h-full rounded-2xl shadow-lg flex flex-col items-center justify-center p-4 backface-hidden rotate-y-180 bg-[linear-gradient(135deg,_var(--portfolio-primary),_var(--portfolio-muted))]"
                    >
                      <p className="text-white text-xs text-center mb-2 leading-tight">{tech.description}</p>
                      <div className="text-xs text-[var(--portfolio-primary-200)] font-medium">{tech.projects.length} projects</div>
                    </div>
                  </div>
          ...
          <div className="text-center">
            ...
            <button
              className="text-white px-8 py-4 rounded-full font-semibold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl bg-[linear-gradient(135deg,_var(--portfolio-primary),_var(--portfolio-muted))]"
            >
