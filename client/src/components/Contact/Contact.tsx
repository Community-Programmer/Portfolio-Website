              ...
              <div className="bg-card rounded-2xl p-8 shadow-lg border border-border h-full flex flex-col">
                ...
                <div className="flex items-center gap-4 mb-6 p-4 bg-muted/50 rounded-xl hover:bg-muted transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <a
                      href={`tel:${generalDetails?.phoneNumber}`}
                ...
                <div className="flex items-center gap-4 mb-8 p-4 bg-muted/50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--portfolio-primary-600)] font-semibold">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <a
                      href={generalDetails?.socialLinks?.instagram}
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        id="name"
                        {...register("name")}
                        className="w-full px-4 py-3 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 ring-[var(--portfolio-primary)]"
                  ...
                  <div className="flex-grow flex flex-col">
                    ...
                    <textarea
                      ...
                      rows={6}
                      {...register("message")}
                      className="w-full px-4 py-3 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 resize-none flex-grow ring-[var(--portfolio-primary)]"
                  ...
                  <Button
                    ...
                    className="w-full py-7 px-6 rounded-xl font-semibold text-white transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl mt-auto bg-[linear-gradient(135deg,_var(--portfolio-primary),_var(--portfolio-muted))]"
                  >
