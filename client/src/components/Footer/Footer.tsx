      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold text-[var(--portfolio-primary)] mb-4 font-serif">
              Sarthak Patel
            </h3>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © 2024 Sarthak Patel. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a
              href="/privacy"
              className="text-muted-foreground hover:text-[var(--portfolio-primary)] text-sm transition-colors"
            >
              Privacy Policy
            </a>
            <a
